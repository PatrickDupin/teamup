...
@section('content')
    <form method="post" action="/jogadores/escalacao" onsubmit="return confirm('Deseja sortear as equipes?')">
        @csrf
        <ul class="collection">
            <li class="collection-header"><h4 class="m-3">Jogadores</h4></li>
        ...
        <div class="row">
            <div class="col">
                <p>
                    Total de Jogadores Confirmados: <span></span>
                </p>
            </div>
            <div class="col right">
...
<script>
    function contabilizarJogador(){
        console.log(document.getElementByName('confirmar-presenca[]').checked);
    }
</script>
@endsection
